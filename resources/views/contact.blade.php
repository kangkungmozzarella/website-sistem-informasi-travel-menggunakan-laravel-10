  ...
  <div class="swiper-container gallery-top">
    <div class="swiper-wrapper">
      ...
      <section class="islands swiper-slide">
        <img src="{{ asset('frontend/assets/img/kontakp.jpg') }}" alt="" class="islands__bg" />
        <div class="bg__overlay">
          <div class="islands__container container">
            <div class="islands__data">
              <h2 class="islands__subtitle">Butuh Liburan?</h2>
  ...
  <div class="contact__container container grid">
    <div class="contact__images">
      ...
      <div class="contact__img">
        <img src="{{ asset('frontend/assets/img/kontak-Copy.jpg') }}" alt="" />
      </div>
    </div>
    ...
    <div class="contact__content">
      <div class="contact__data">
        ...
        <p class="contact__description">
          Apakah ada masalah dalam mencari tempat untuk perjalanan Anda berikutnya? Butuh panduan di perjalanan pertama atau butuh konsultasi seputar traveling? Cukup hubungi kami.
        </p>
      </div>
        ...
        <div class="contact__card-box">
          <div class="contact__card-info">
            ...
            <div>
              ...
              <p class="contact__card-description">081292015768</p>
            </div>
          </div>
