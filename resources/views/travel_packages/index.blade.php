    ...
    <div class="swiper-container gallery-top">
        <div class="swiper-wrapper">
            <section class="islands swiper-slide">
                <img src="{{ asset('frontend/assets/img/sawah.jpg') }}" alt="" class="islands__bg" />

                <div class="islands__container container">
                    <div class="islands__data">
                        <h2 class="islands__subtitle">Jelajahi</h2>
                        <h1 class="islands__title">Paket Travel</h1>
                    </div>
                </div>
            </section>
        </div>
            ...
            <article class="popular__card">
                <a href="{{ route('travel_package.show', $travel_package->slug) }}">
                    ...
                    <div class="popular__data">
                        <h2 class="popular__price"><span>Rp.</span>{{ number_format($travel_package->price) }}</h2>
